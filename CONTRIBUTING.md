# Contributing to eslint-config-charlint

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `eslint-config-charlint`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `eslint-config-charlint` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/eslint-config-charlint/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of `eslint-config-charlint`.

The [`question` label](https://github.com/tunnckoCore/eslint-config-charlint/labels/question%20%2F%20discussion) is a good place to find ongoing discussions.
...
1. **version**: what version of `eslint-config-charlint` were you using when you experienced the bug?
